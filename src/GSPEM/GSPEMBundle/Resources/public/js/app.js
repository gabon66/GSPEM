var GSPEMApp = angular.module('AppGSPEM', ["720kb.datepicker","ngExcel","lr.upload","angucomplete","ngMaterial","checklist-model",'ngRoute','ngAnimate','ui.bootstrap','toastr','ngAutocomplete','google.places']);
